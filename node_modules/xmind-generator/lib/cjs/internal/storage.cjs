...
exports.computeResourcePath = computeResourcePath;
exports.makeImageResourceStorage = makeImageResourceStorage;
function makeImageResourceStorage() {
...
async function computeResourcePath(resource) {
